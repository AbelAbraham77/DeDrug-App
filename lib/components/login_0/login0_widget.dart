...
class Login0Widget extends StatefulWidget {
  /// just add some more details inside it
...
class _Login0WidgetState extends State<Login0Widget> {
  ...
  void initState() {
    ...
    _model.cpasswordLoginTextController ??= TextEditingController();
    _model.cpasswordLoginFocusNode ??= FocusNode();
  }
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'i7f18cve' /* Enter your  first name.... */,
                                    ),
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.cpasswordLoginTextController,
                                  focusNode: _model.cpasswordLoginFocusNode,
                                  obscureText: !_model.cpasswordLoginVisibility,
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'dx8g1k2i' /* ConfirmPassword */,
                                    ),
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                                    ...
                                    suffixIcon: InkWell(
                                      onTap: () => safeSetState(
                                        () => _model.cpasswordLoginVisibility =
                                            !_model.cpasswordLoginVisibility,
                                      ),
                                      focusNode: FocusNode(skipTraversal: true),
                                      child: Icon(
